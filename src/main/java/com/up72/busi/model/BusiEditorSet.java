 ...
 * @since 1.0
 */
public class BusiEditorSet implements java.io.Serializable{
	
	//alias
	public static final String TABLE_ALIAS = "编辑器设置";
	...
	public boolean equals(Object obj) {
		if(obj instanceof BusiEditorSet == false) return false;
		if(this == obj) return true;
		BusiEditorSet other = (BusiEditorSet)obj;
