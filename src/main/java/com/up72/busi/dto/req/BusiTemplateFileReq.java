 ...
 * @since 1.0
 */
public class BusiTemplateFileReq  implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		if(obj instanceof BusiTemplateFileReq == false) return false;
		if(this == obj) return true;
		BusiTemplateFileReq other = (BusiTemplateFileReq)obj;
