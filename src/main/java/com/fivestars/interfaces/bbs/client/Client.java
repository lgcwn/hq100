...
public class Client extends PHPFunctions{
	...
	public static String UC_IP = "120.76.190.132";
	public static String UC_API = "http://120.76.190.132/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "a63cw6PZ+593JQCgyttARncJ6xLeOigbku2osCs";
